...
describe("FlashSwap Contract", () => {
  ...
  const WBNB = "0x2c094F5A7D1146BB93850f629501eB749f6Ed491";
    ...
    [owner] = await ethers.getSigners();
      ...
      describe("Arbitrage Execution", () => {
        ...
        it("executes the arbitrage", async () => {
          /////
          // Print balances
          const rawBal = await FLASHSWAP.getBalanceOfToken(BUSD);
          const bal = Number(
            ethers.utils.formatUnits(rawBal, DECIMALS)
          );
          console.log("Balance of BUSD init: " + bal);
          /////
